...
void QuadDec_1_Enable(void)
{
    ...
    #if (QuadDec_1__QUAD == QuadDec_1_CONFIG)
        #if (0u != QuadDec_1_QUAD_AUTO_START)
            QuadDec_1_TriggerCommand(QuadDec_1_MASK, QuadDec_1_CMD_RELOAD);
        #endif /* (0u != QuadDec_1_QUAD_AUTO_START) */
    #endif  /* (QuadDec_1__QUAD == QuadDec_1_CONFIG) */
}
...
*   Values:
*     - QuadDec_1_CMD_CAPTURE    - Trigger Capture/Switch command
*     - QuadDec_1_CMD_RELOAD     - Trigger Reload/Index command
*     - QuadDec_1_CMD_STOP       - Trigger Stop/Kill command
*     - QuadDec_1_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*
