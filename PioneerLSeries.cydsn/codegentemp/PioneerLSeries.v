// ======================================================================
// PioneerLSeries.v generated from TopDesign.cysch
// 04/21/2018 at 14:21
...
`ifdef WARP
`define CY_BLK_DIR "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`else
`define CY_BLK_DIR "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0"
`include "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0\or_v1_0.v"
`else
`define CY_BLK_DIR "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0"
`include "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\or_v1_0\or_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0"
`include "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0"
`include "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50"
`include "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50\Bus_Connect_v2_50.v"
`else
`define CY_BLK_DIR "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50"
`include "E:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50\Bus_Connect_v2_50.v"
`endif
...
module ADC_SAR_SEQ_P4_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("9b459b3a-3ff0-4b6b-89fd-bb18968481ed/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("690e2a23-e363-4b42-8cb1-0ad2b3a32786/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Pot2Pin_net;
	wire [0:0] tmpFB_0__Pot2Pin_net;
	wire [0:0] tmpIO_0__Pot2Pin_net;
	wire [0:0] tmpINTERRUPT_0__Pot2Pin_net;
	electrical [0:0] tmpSIOVREF__Pot2Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("d87111f8-a31e-4e73-b5fc-e70508409c2b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Pot2Pin
		 (.oe(tmpOE__Pot2Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pot2Pin_net[0:0]}),
		  .analog({Net_87}),
		  .io({tmpIO_0__Pot2Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Pot2Pin_net),
		  .interrupt({tmpINTERRUPT_0__Pot2Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pot2Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pot1Pin_net;
	wire [0:0] tmpFB_0__Pot1Pin_net;
	wire [0:0] tmpIO_0__Pot1Pin_net;
	wire [0:0] tmpINTERRUPT_0__Pot1Pin_net;
	electrical [0:0] tmpSIOVREF__Pot1Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("b05bf64a-8a94-4c4b-9a81-4b3da3e3a94f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pot1Pin
		 (.oe(tmpOE__Pot1Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pot1Pin_net[0:0]}),
		  .analog({Net_89}),
		  .io({tmpIO_0__Pot1Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Pot1Pin_net),
		  .interrupt({tmpINTERRUPT_0__Pot1Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pot1Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pot0Pin_net;
	wire [0:0] tmpFB_0__Pot0Pin_net;
	wire [0:0] tmpIO_0__Pot0Pin_net;
	wire [0:0] tmpINTERRUPT_0__Pot0Pin_net;
	electrical [0:0] tmpSIOVREF__Pot0Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pot0Pin
		 (.oe(tmpOE__Pot0Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pot0Pin_net[0:0]}),
		  .analog({Net_91}),
		  .io({tmpIO_0__Pot0Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Pot0Pin_net),
		  .interrupt({tmpINTERRUPT_0__Pot0Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pot0Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
